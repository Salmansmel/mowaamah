...
export const en: Dictionary = {
  ...
  upload: {
    ...
    dropzoneHint: 'DOCX files only, max 10MB',
    errorInvalidType: 'Unsupported file type. Please upload a DOCX file.',
  ...
  about: {
    ...
    step1Body: 'Submit your technical and regulatory requirement documents as DOCX.',
    step2Title: '2. Text Extraction (DOCX)',
    step2Body: 'The platform extracts the text from your DOCX file ahead of precise analysis.',
